...
(function (e, t) {
  ...
  define("text!templates/snippet/passwordinput.html", [], function () {
    return '<!-- Password input-->\n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%> >\n    <input id="<%= id %>" name="<%= id %>" type="password" placeholder="<%= placeholder %>" class="form-control btn-square input-md glassmorph" <% if(required) {%> required <% } %> />\n    <% if (helptext.length > 0) { %><span class="help-block"><%= helptext %></span><% } %>\n  </div>\n</div>\n';
  }),
  ...
  define("text!templates/snippet/selectbasic.html", [], function () {
    return '<!-- Select Basic -->\n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%>>\n    <select id="<%= id %>" name="<%= id %>" class="form-control btn-square glassmorph"><% _.each(options, function(option,i) { %>\n      <option value="<%= values[i] %>"><%= option %></option><% }); %>\n    </select>\n  </div>\n</div>\n';
  }),
  define("text!templates/snippet/selectmultiple.html", [], function () {
    return '<!-- Select Multiple -->\n<div class="mb-3 row mb-0">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%>>\n    <select id="<%= id %>" name="<%= id %>" class="form-control btn-square glassmorph" multiple="multiple"><% _.each(options, function(option,i) { %>\n      <option value="<%= values[i] %>"><%= option %></option><% }); %>\n    </select>\n  </div>\n</div>\n';
  }),
  define("text!templates/snippet/textarea.html", [], function () {
    return '<!-- Textarea -->\n<div class="mb-3 row mb-0">\n  <label class="col-lg-12 form-label text-lg-start" for ="<%= id %>"><%= label %></label>\n  <div class="col-lg-12" >                     \n    <textarea class="form-control btn-square glassmorph" id="<%= id %>" name="<%= id %>" ><%= textarea %></textarea>\n  </div>\n</div>\n';
  }),
  define(
